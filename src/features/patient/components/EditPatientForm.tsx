...
export function EditPatientForm({
  ...
  const { control, handleSubmit } = useUpdatePatientForm(patient);
  ...
  const onSubmit: SubmitHandler<UpdatePatient> = async (updatedPatient) => {
    setIsUpdating(true);
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <SearchableMultiSelect<Condition>
                      ...
                      selectedItems={(field.value || []) as Condition[]}
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <SearchableMultiSelect<Medication>
                      ...
                      selectedItems={(field.value || []) as unknown as Medication[]}
                      onItemsChange={field.onChange}
